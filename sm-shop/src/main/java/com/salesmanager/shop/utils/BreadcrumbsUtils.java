...
public class BreadcrumbsUtils {
	...
	public Breadcrumb buildCategoryBreadcrumb(ReadableCategory categoryClicked, MerchantStore store, Language language,
		...
		for (Category c : categories) {
			...
			categoryBreadcrump
					.setUrl(filePathUtils.buildCategoryUrl(store, contextPath, c.getDescription().getSeUrl()));
	...
	public Breadcrumb buildProductBreadcrumb(String refContent, ReadableProduct productClicked, MerchantStore store,
		...
		productBreadcrump.setUrl(
				filePathUtils.buildProductUrl(store, contextPath, productClicked.getDescription().getFriendlyUrl()));
