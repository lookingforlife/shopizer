...
public class ConfigurationController {
	...
	public String displayAccountsConfguration(Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		 ...
		 * if(null == merchantGoogleApiConfiguration) { merchantGoogleApiConfiguration =
	...
	public String saveConfigurations(@ModelAttribute("configuration") ConfigListWrapper configWrapper,
		...
		for (MerchantConfiguration mConfigs : configs) {
			...
			if (!StringUtils.isBlank(mConfigs.getValue())) {
				...
				MerchantConfiguration config = merchantConfigurationService.getMerchantConfiguration(mConfigs.getKey(),
						store);
				if (config != null) {
	...
	public String displayEmailSettings(Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		...
		if (emailConfig == null) {
			...
			// instead of showing blank fields in setup screen, show default configured
			// values from email.properties
	...
	public String saveEmailSettings(@ModelAttribute("configuration") EmailConfig config, BindingResult result,
