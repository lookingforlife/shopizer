...
public class CustomShippingMethodsController {
	...
	public String getWeightBasedShippingMethod(Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public String addCustomRegion(@ModelAttribute("region") String region, BindingResult result, Model model,
	...
	public String addCountryToCustomRegion(@ModelAttribute("customRegion") CustomShippingQuotesRegion customRegion,
	...
	public String saveShippingMethod(@ModelAttribute("configuration") CustomShippingQuotesConfiguration configuration,
			BindingResult result, Model model, HttpServletRequest request, HttpServletResponse response, Locale locale)
			throws Exception {
	...
	public @ResponseBody ResponseEntity<String> deleteCountry(HttpServletRequest request, HttpServletResponse response,
			Locale locale) {
	...
	public @ResponseBody ResponseEntity<String> deletePrice(HttpServletRequest request, HttpServletResponse response,
			Locale locale) {
	...
	public @ResponseBody ResponseEntity<String> checkRegionCode(HttpServletRequest request,
	...
	public @ResponseBody ResponseEntity<String> pageCustomShipping(HttpServletRequest request,
	...
	public @ResponseBody ResponseEntity<String> pageCustomShippingDetails(HttpServletRequest request,
			HttpServletResponse response) {
	...
	public String addPrice(@ModelAttribute("region") String customRegion,
			@ModelAttribute("customQuote") CustomShippingQuoteWeightItem customQuote, BindingResult result, Model model,
			HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
	...
	private void populateModel(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// shippingService.getSupportedCountries(store);
		 ...
		 * if(shippingConfiguration.getShippingType().name().equals(ShippingType.
		 * INTERNATIONAL.name())){
		 * 
		 * for(String key : countries.keySet()) { Country country =
		 * (Country)countries.get(key); if(includedCountries.contains(key)) {
		 * shippingCountries.add(country); } } } else {//if national only store country
