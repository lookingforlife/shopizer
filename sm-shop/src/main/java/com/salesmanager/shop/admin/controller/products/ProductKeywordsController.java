...
public class ProductKeywordsController {
	...
	public String displayKeywords(@RequestParam("id") long productId, Model model, HttpServletRequest request,
	...
	public @ResponseBody ResponseEntity<String> removeKeyword(@RequestParam("id") long productId,
