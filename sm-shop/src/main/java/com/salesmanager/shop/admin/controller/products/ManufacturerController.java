...
public class ManufacturerController {
	...
	public String getManufacturers(Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public String createManufacturer(Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public String editManufacturer(@RequestParam("id") long manufacturerId, Model model, HttpServletRequest request,
	...
	public String saveManufacturer(
		...
		if (manufacturer.getDescriptions() != null && manufacturer.getDescriptions().size() > 0) {
			...
			for (ManufacturerDescription description : manufacturer.getDescriptions()) {
				...
				/*
				 * if ( description.getUrlClicked() != null &&
				 * !description.getUrlClicked().toString().isEmpty()) { try{ Integer.parseInt(
				 * description.getUrlClicked().toString() );
				 * 
				 * } catch (Exception e) {
				 * 
				 * ObjectError error = new ObjectError(
				 * "descriptions[${counter.index}].urlClicked","URL Clicked must be a number");
		...
		// manufacturer.getManufacturerImage().getId() == null) {
		...
		if (manufacturer.getImage() != null && !manufacturer.getImage().isEmpty()) {
			...
			// for(Language l : languages) {
			//
			// ManufacturerImageDescription imageDescription = new
			// ManufacturerImageDescription();
	...
	public @ResponseBody ResponseEntity<String> pageManufacturers(HttpServletRequest request,
	...
	public @ResponseBody ResponseEntity<String> deleteManufacturer(HttpServletRequest request,
	...
	public @ResponseBody ResponseEntity<String> checkCode(HttpServletRequest request, HttpServletResponse response,
			Locale locale) {
