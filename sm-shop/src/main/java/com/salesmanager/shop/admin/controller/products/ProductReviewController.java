...
public class ProductReviewController {
	...
	public String displayProductReviews(@RequestParam("id") long productId, Model model, HttpServletRequest request,
	...
	public @ResponseBody ResponseEntity<String> pageProductReviews(HttpServletRequest request,
	...
	public @ResponseBody ResponseEntity<String> deleteProductReview(HttpServletRequest request,
