...
public class GroupsController {
	...
	public String displayGroup(@RequestParam("id") Integer groupId, Model model, Locale locale,
	...
	public @ResponseBody ResponseEntity<String> delete(Model model, Locale locale, HttpServletRequest request,
	...
	public String save(@Valid @ModelAttribute("group") GroupDetails group, BindingResult result, Locale locale,
	...
	public String displayGroup(Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		// display menu
		setMenu(model, request);
	...
	public @ResponseBody ResponseEntity<String> pageGroups(HttpServletRequest request, HttpServletResponse response,
			Locale locale) {
