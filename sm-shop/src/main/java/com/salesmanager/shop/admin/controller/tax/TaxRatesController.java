...
public class TaxRatesController {
	...
	public String displayTaxRates(Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public @ResponseBody ResponseEntity<String> pageTaxRates(HttpServletRequest request, HttpServletResponse response) {
	...
	public String saveTaxRate(@Valid @ModelAttribute("taxRate") TaxRate taxRate, BindingResult result, Model model,
	...
	public String updateTaxRate(@Valid @ModelAttribute("taxRate") TaxRate taxRate, BindingResult result, Model model,
			HttpServletRequest request, Locale locale) throws Exception {
	...
	private void validateTaxRate(Model model, TaxRate taxRate, BindingResult result, MerchantStore store,
			Language language, Locale locale) throws Exception {
		...
		// FieldError("taxRate","piggyback",messages.getMessage("NotNull.taxRate.parent",
		// locale));
		// result.addError(error);
		// }
	...
	public @ResponseBody ResponseEntity<String> removeTaxRate(HttpServletRequest request, Locale locale)
			throws Exception {
	...
	public String editTaxRate(@ModelAttribute("id") String id, Model model, HttpServletRequest request,
