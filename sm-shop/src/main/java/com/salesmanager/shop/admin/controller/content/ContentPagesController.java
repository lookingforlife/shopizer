...
public class ContentPagesController {
	...
	public String listContentPages(Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public String getContentDetails(@RequestParam("id") Long id, Model model, HttpServletRequest request,
	...
	public @ResponseBody ResponseEntity<String> removeContent(HttpServletRequest request, HttpServletResponse response,
			Locale locale) {
	...
	public @ResponseBody ResponseEntity<String> pageStaticContent(@RequestParam("contentType") String contentType,
	...
	public String saveContent(@Valid @ModelAttribute Content content, BindingResult result, Model model,
	...
	public @ResponseBody ResponseEntity<String> checkContentCode(HttpServletRequest request,
