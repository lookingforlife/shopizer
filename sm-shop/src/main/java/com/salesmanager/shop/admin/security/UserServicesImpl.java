...
public class UserServicesImpl implements WebUserServices {
	...
	private static final String DEFAULT_INITIAL_PASSWORD = "111";
	...
	public void createDefaultAdmin() throws Exception {
		...
		com.salesmanager.core.model.user.User user = new com.salesmanager.core.model.user.User("admin", password,
				"su221411@163.com");
