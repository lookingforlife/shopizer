...
public class CustomProductGroupsController {
	...
	public String displayProductGroups(Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public @ResponseBody ResponseEntity<String> pageCustomGroups(HttpServletRequest request,
	...
	public String saveCustomProductGroup(@ModelAttribute("group") ProductRelationship group, BindingResult result,
	...
	public @ResponseBody ResponseEntity<String> removeCustomProductGroup(HttpServletRequest request,
			HttpServletResponse response) {
	...
	public @ResponseBody ResponseEntity<String> activateProductGroup(HttpServletRequest request,
			HttpServletResponse response) {
