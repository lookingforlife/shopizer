...
public class CustomerController {
	...
	public String displayCustomer(Long id, Model model, HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	private void getCustomerOptions(Model model, Customer customer, MerchantStore store, Language language)
			throws Exception {
	...
	public @ResponseBody ResponseEntity<String> pageCustomers(HttpServletRequest request,
	...
	public @ResponseBody ResponseEntity<String> resetPassword(HttpServletRequest request,
			HttpServletResponse response) {
	...
	public @ResponseBody ResponseEntity<String> setCredentials(HttpServletRequest request,
			HttpServletResponse response) {
		...
		try {
			 ...
			 * try {
			 * 
			 * //creation of a user, send an email String[] storeEmail =
			 * {store.getStoreEmailAddress()};
			 * 
			 * 
			 * Map<String, String> templateTokens =
			 * emailUtils.createEmailObjectsMap(request.getContextPath(), store, messages,
			 * customerLocale); templateTokens.put(EmailConstants.LABEL_HI,
			 * messages.getMessage("label.generic.hi", customerLocale));
			 ...
			 * 
			 * 
			 * Email email = new Email(); email.setFrom(store.getStorename());
			 * email.setFromEmail(store.getStoreEmailAddress());
			 * email.setSubject(messages.getMessage("label.generic.changepassword",
			 * customerLocale)); email.setTo(customer.getEmailAddress());
			 ...
			 * resp.setStatus(AjaxResponse.RESPONSE_STATUS_SUCCESS);
			 * 
			 * } catch (Exception e) { LOGGER.error("Cannot send email to user",e);
			 * resp.setStatus(AjaxResponse.RESPONSE_STATUS_FAIURE); }
			 */
