...
public class ProductAttributeController {
	...
	public String displayProductAttributes(@RequestParam("id") long productId, Model model, HttpServletRequest request,
	...
	public @ResponseBody ResponseEntity<String> pageAttributes(HttpServletRequest request,
	...
	public String displayAttributeEdit(@RequestParam("productId") Long productId, @RequestParam("id") Long id,
	...
	public String saveAttribute(@Valid @ModelAttribute("attribute") ProductAttribute attribute, BindingResult result,
		...
		if (option.getProductOptionType().equals(TEXT_OPTION)) {
			...
			if (dbEntity != null && dbEntity.getProductOption().getProductOptionType().equals(TEXT_OPTION)) {// bcz it
																												// is
																												// overwrited
																												// by
																												// hidden
				...
				if (dbEntity.getProductOptionValue() != null) {
					...
					for (ProductOptionValueDescription description : descriptions) {
						...
						description.setName(description.getDescription().length() < 15 ? description.getDescription()
				...
				for (ProductOptionValueDescription description : descriptions) {
					...
					optionValueDescription
							.setName(description.getDescription().length() < 15 ? description.getDescription()
									: description.getDescription().substring(0, 15));
					optionValueDescription.setLanguage(description.getLanguage());
	...
	public @ResponseBody ResponseEntity<String> deleteProductPrice(HttpServletRequest request,
	...
	public @ResponseBody ResponseEntity<String> checkAttributeType(HttpServletRequest request,
			HttpServletResponse response, Locale locale) {
