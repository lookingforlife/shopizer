...
public class ShopProductRelationshipTag extends RequestContextAwareTag {
	...
	protected int doStartTagInternal() throws Exception {
		...
		groupKey.append(store.getId()).append("_").append(Constants.PRODUCTS_GROUP_CACHE_KEY).append("-")
				.append(this.getGroupName()).append("_").append(language.getCode());
	...
	private List<ReadableProduct> getProducts(HttpServletRequest request) throws Exception {
		...
		List<ProductRelationship> relationships = productRelationshipService.getByGroup(store, this.getGroupName(),
				language);
