...
public class ModulesApi {
	...
	/**
	 * Creates or updates a configuration module. A JSON has to be created on the
	 * client side which represents an object that will create a new module
	 ...
	 * 
	 * { "module": "PAYMENT", "code": "paypal-express-checkout", "type":"paypal",
	 ...
	 * }
	 *
	 * see : shopizer/sm-core/src/main/resources/reference/integrationmodules.json
	 * for more samples
	 * 
	 * @param json
	 * @param request
	 ...
	 * 
	 * @ApiOperation( httpMethod = "POST", value = "Creates a new module", notes =
	 * "", produces = "application/json") public ReadableEntity
	 * createModule(@RequestBody String json, HttpServletRequest request) {
	 * 
	 * LOGGER.debug("Creating an integration module : " + json);
	 * 
	 * try { moduleConfigurationService.createOrUpdateModule(json); } catch
	 * (ServiceException e) { // TODO Auto-generated catch block throw new
	 * RestApiException(e); }
	 * 
