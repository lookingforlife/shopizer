...
/**
 * Api for searching shopizer catalog based on search term when filtering
 * products based on product attribute is required, see /api/v1/product
 *
 * @author c.samson
 */
@RestController
...
public class SearchApi {
	...
	public @ResponseBody SearchProductList search(@RequestBody SearchProductRequest searchRequest,
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
			@ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en") })
	public @ResponseBody ValueList autocomplete(@RequestBody SearchProductRequest searchRequest,
			@ApiIgnore MerchantStore merchantStore, @ApiIgnore Language language, HttpServletRequest request) {
