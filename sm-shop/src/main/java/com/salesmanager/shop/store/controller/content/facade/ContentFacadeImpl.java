...
public class ContentFacadeImpl implements ContentFacade {
	...
	private Content convertContentPageToContent(MerchantStore store, Language language, Content content,
			PersistableContentPage contentPage) {
	...
	// private ContentDescription createOrUpdateContentDescription(MerchantStore
	// store, Content contentModel, ObjectContent content,
	// Language language) {
	private ContentDescription createContentDescription(MerchantStore store, ObjectContent content, Language language) {
	...
	private void setContentDescriptionToContentModel(Content content, ContentDescription contentDescription,
		...
		if (contentDescriptionModel.isPresent()) {
			contentDescriptionModel.get().setMetatagDescription(contentDescription.getMetatagDescription());
