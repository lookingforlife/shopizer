...
public class ProductGroupApi {
	...
	/**
	 * Query for a product group public/products/group/{code}?lang=fr|en no lang it
	 * will take session lang or default store lang code can be any code used while
	 * creating product group, defeult being FEATURED
	 *
	 * @param store
	 * @param language
	 * @param groupCode
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
			@ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en") })
	public @ResponseBody ReadableProductList addProductToGroup(@PathVariable Long productId, @PathVariable String code,
			@ApiIgnore MerchantStore merchantStore, @ApiIgnore Language language, HttpServletResponse response) {
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
			@ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en") })
	public @ResponseBody ReadableProductList removeProductFromCategory(@PathVariable Long productId,
