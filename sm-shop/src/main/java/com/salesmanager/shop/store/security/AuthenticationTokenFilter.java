...
public class AuthenticationTokenFilter extends OncePerRequestFilter {
	...
	/*
	 * private void setHeader(HttpServletRequest request, HttpServletResponse
	 * response) {
	 * 
	 * 
	 * 
	 * 
	 * String origin = request.getHeader("origin"); if(StringUtils.isBlank(origin))
	 * { origin = "*"; } response.setHeader("Access-Control-Allow-Methods",
	 ...
	 *//**
		 ...
		 *//*
			 * 
			 * if("options".equalsIgnoreCase(request.getMethod())) { try {
			 * ((HttpServletResponse) response).setStatus(200); byte[] b = "".getBytes();
			 * response.getOutputStream().write(b); return; } catch(Exception e) {
			 * e.printStackTrace(); }
			 * 
			 * }
			 * 
