...
public class AuthenticateCustomerApi {
	...
	@ResponseBody
	public ResponseEntity<?> register(@Valid @RequestBody PersistableCustomer customer, HttpServletRequest request,
		...
		try {
			...
			try {
				...
				authentication = jwtCustomerAuthenticationManager.authenticate(
						new UsernamePasswordAuthenticationToken(customer.getUserName(), customer.getClearPassword()));
	...
	public ResponseEntity<?> authenticate(@RequestBody @Valid AuthenticationRequest authenticationRequest,
		...
		try {
			...
			authentication = jwtCustomerAuthenticationManager.authenticate(new UsernamePasswordAuthenticationToken(
	...
	public ResponseEntity<?> resetPassword(@RequestBody @Valid AuthenticationRequest authenticationRequest,
		...
		try {
			...
			Customer customer = customerFacade.getCustomerByUserName(authenticationRequest.getUsername(),
					merchantStore);
