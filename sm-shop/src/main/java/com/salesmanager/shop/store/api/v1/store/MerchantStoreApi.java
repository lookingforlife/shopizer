...
public class MerchantStoreApi {
	...
	@ApiOperation(httpMethod = "POST", value = "Create store branding and marketing details", notes = "", response = ReadableBrand.class)
	...
	@ApiOperation(httpMethod = "GET", value = "Check list of stores", notes = "", response = ReadableMerchantStoreList.class)
	public ReadableMerchantStoreList list(@RequestParam(value = "start", required = false) Integer start,
