...
public class UserApi {
	 ...
	 */
	@ResponseStatus(HttpStatus.OK)
	@PostMapping(value = { "/private/{store}/user/", "/private/user/" }, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@ApiOperation(httpMethod = "PUT", value = "Updates a user password", notes = "", response = Void.class)
	@ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "string", defaultValue = "DEFAULT"),
			@ApiImplicitParam(name = "lang", dataType = "string", defaultValue = "en") })
	...
	@ResponseStatus(HttpStatus.OK)
	@GetMapping(value = { "/private/{store}/users/", "/private/users/" }, produces = MediaType.APPLICATION_JSON_VALUE)
