...
public class OrderRESTController {
	...
	/**
	 * This method is for adding order to the system. Generally used for the purpose
	 * of migration only This method won't process any payment nor create
	 * transactions
	 * 
	 * @param store
	 * @param order
	...
	@ResponseBody
	public PersistableOrder createOrder(@PathVariable final String store, @Valid @RequestBody PersistableOrder order,
	...
	/**
	 * Get a list of orders accept request parameter 'lang' [en,fr...] otherwise
	 * store dafault language accept request parameter 'start' start index for count
	...
	/**
	 * Get a list of orders for a given customer accept request parameter 'lang'
	 * [en,fr...] otherwise store dafault language accept request parameter 'start'
