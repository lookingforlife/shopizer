...
public class CategoryApi {
	...
	@GetMapping(value = "/category/{id}", produces = { APPLICATION_JSON_VALUE, APPLICATION_XML_VALUE })
	 ...
	 * @return
	 */
	@GetMapping(value = "/category", produces = { APPLICATION_JSON_VALUE, APPLICATION_XML_VALUE })
	@ApiOperation(httpMethod = "GET", value = "Get category hierarchy from root", notes = "Does not return any product attached")
	@ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "string", defaultValue = "DEFAULT"),
			@ApiImplicitParam(name = "lang", dataType = "string", defaultValue = "en") })
	public List<ReadableCategory> getFiltered(@RequestParam(value = "filter", required = false) String filter,
			@ApiIgnore MerchantStore merchantStore, @ApiIgnore Language language) {
		return categoryFacade.getCategoryHierarchy(merchantStore, DEFAULT_CATEGORY_DEPTH, language, filter);
	}

	@PostMapping(value = "/private/category", produces = { APPLICATION_JSON_VALUE, APPLICATION_XML_VALUE })
	@ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "string", defaultValue = "DEFAULT"),
			@ApiImplicitParam(name = "lang", dataType = "string", defaultValue = "en") })
	...
	@PutMapping(value = "/private/category/{id}", produces = { APPLICATION_JSON_VALUE, APPLICATION_XML_VALUE })
	@ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "string", defaultValue = "DEFAULT") })
	...
	/*
	 * @PutMapping( value = "/private/category/{id}/move/{parent}", produces =
	 * {APPLICATION_JSON_VALUE, APPLICATION_XML_VALUE})
	 * 
	 * @ApiOperation( httpMethod = "PUT", value =
	 * "Move a category under another category", notes =
	 * "Move category {id} under category {parent}")
	 * 
	 * @ApiImplicitParams({
	 * 
	 ...
	 * 
	 * @ApiIgnore MerchantStore merchantStore) { return; }
	 */

	@DeleteMapping(value = "/private/category/{id}", produces = { APPLICATION_JSON_VALUE, APPLICATION_XML_VALUE })
