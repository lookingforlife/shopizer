...
public class SearchFacadeImpl implements SearchFacade {
	...
	public SearchProductList search(MerchantStore store, Language language, SearchProductRequest searchRequest) {
		...
		SearchResponse response = search(store, language.getCode(), query, searchRequest.getCount(),
	...
	@Override
	public SearchProductList copySearchResponse(SearchResponse searchResponse, MerchantStore merchantStore, int start,
		...
		if (facets != null) {
			...
			if (!CollectionUtils.isEmpty(categoriesFacets)) {
				...
				List<ReadableCategory> categoryProxies = categories.stream()
