...
public class OrderApi {
	...
	public ReadableOrderList listOrders(@PathVariable final Long id,
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "string", defaultValue = "DEFAULT"),
			@ApiImplicitParam(name = "lang", dataType = "string", defaultValue = "en") })
	public ReadableOrderList listOrders(@RequestParam(value = "start", required = false) Integer start,
			@RequestParam(value = "count", required = false) Integer count, @ApiIgnore MerchantStore merchantStore,
	...
	/**
	 * This method returns list of all the orders for the admin.This is not bound to
	...
	public ReadableOrderList getOrders(
			...
			@RequestParam(value = "draw", required = false) String draw) throws Exception {
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "string", defaultValue = "DEFAULT"),
			@ApiImplicitParam(name = "lang", dataType = "string", defaultValue = "en") })
	public PersistableOrderApi checkout(@PathVariable final Long id, @Valid @RequestBody PersistableOrderApi order,
