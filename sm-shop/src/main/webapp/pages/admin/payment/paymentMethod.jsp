  	...
  	<div class="tab-content">
  		<div class="tab-pane active" id="payment-method">
			<div class="sm-ui-component">
				<h3>
					<s:message code="label.payment.module.title" text="Payment method" /> - <s:message code="module.payment.${configuration.moduleCode}" text="No label found - ${configuration.moduleCode}"/>
				</h3>	
				<br/>
				...
				<form:form method="POST" commandName="configuration" action="${savePaymentMethod}">
					...
					<div class="control-group">
                        <label>
                        	<s:message code="label.entity.enabled" text="Module enabled"/>
                        </label>
                        <div class="controls">
