	...
	<div class="tab-content">
		<div class="tab-pane active" id="shipping-method">
			<div class="sm-ui-component">
				<h3><s:message code="label.shipping.title" text="Shipping configuration" /> - <s:message code="module.shipping.${configuration.moduleCode}" arguments="${requestScope.ADMIN_STORE.storename}" text="No label found - ${configuration.moduleCode}"/>
				</h3>	
				<br/>
				<s:message code="module.shipping.${configuration.moduleCode}.note" text=""/>
				<br/>
