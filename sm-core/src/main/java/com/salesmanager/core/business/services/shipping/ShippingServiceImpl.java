...
public class ShippingServiceImpl implements ShippingService {
	...
	public ShippingQuote getShippingQuote(Long shoppingCartId, MerchantStore store, Delivery delivery,
		...
		try {
			...
			// must have a shipping module configured  MerchantConfiguration
			...
			/** merchant module configs moduleConfiguration **/
			...
			if (shippingOptions == null && !StringUtils.isBlank(delivery.getPostalCode())) {
				...
				// absolutely need to use in this case store pickup or other default shipping
				// quote
	...
	@Override
	public boolean requiresShipping(List<ShoppingCartItem> items, MerchantStore store) throws ServiceException {
