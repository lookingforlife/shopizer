 ...
 * 
 * Requires a configuration of a message note to be printed to the client and a
 * price for calculation (should be configured to 0)
 * 
	...
	public void prePostProcessShippingQuotes(ShippingQuote quote, List<PackageDetails> packages, BigDecimal orderTotal,
		...
		try {
			...
			shippingOption.setOptionPriceText(
					productPriceUtils.getStoreFormatedAmountWithCurrency(store, productPriceUtils.getAmount(price)));
