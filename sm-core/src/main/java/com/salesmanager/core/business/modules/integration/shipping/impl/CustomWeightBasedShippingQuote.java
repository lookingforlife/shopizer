...
public class CustomWeightBasedShippingQuote implements ShippingQuoteModule {
	...
	public CustomIntegrationConfiguration getCustomModuleConfiguration(MerchantStore store)
		...
		try {
			...
			MerchantConfiguration configuration = merchantConfigurationService.getMerchantConfiguration(MODULE_CODE,
					store);
			...
			if (configuration != null) {
				...
				try {
					CustomShippingQuotesConfiguration config = mapper.readValue(value,
							CustomShippingQuotesConfiguration.class);
					return config;
				} catch (Exception e) {
